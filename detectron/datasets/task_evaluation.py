...
import detectron.datasets.caltech_dataset_evaluator as caltech_dataset_evaluator
import detectron.datasets.kaist_dataset_evaluator as kaist_dataset_evaluator
import detectron.datasets.scut_dataset_evaluator as scut_dataset_evaluator
...
def evaluate_boxes(dataset, all_boxes, output_dir, use_matlab=False):
    ...
    elif _use_kaist_evaluator(dataset):
        kaist_eval = kaist_dataset_evaluator.evaluate_boxes(
            dataset, all_boxes, output_dir
        )
...
def _use_kaist_evaluator(dataset):
